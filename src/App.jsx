...
const customers = [
  {
    ...
    services: 1,
    deployments: 1,
    lastActivity: "Active customer",
    website: "https://sunshine-backend.pages.dev/",
    description: "Sunshine Solution customer environment managed through Atlaris customer operations.",
  },
  {
    id: "CUS-002",
    ...
    description: "Vancouver RealEstateIQ customer environment managed through Atlaris customer operations.",
  },
  {
    id: "CUS-003",
    name: "AIport",
    ...
    description: "AIport customer environment managed through Atlaris customer operations.",
  },
];
...
function App() {
  ...
  function renderOverview() {
    return <>
      ...
      <section className="stats-grid"><StatCard label="Infrastructure health" value="Healthy" detail="atlas01 online · agent + tunnel ready" accent="CORE" /><StatCard label="Managed customers" value={customers.length} detail={`${customers.length} active customer environments`} accent="CRM" /><StatCard label="Production releases" value="5" detail="Current release protected by rollback" accent="CD" /><StatCard label="MCP capabilities" value="26" detail="Controlled administration tools" accent="MCP" /></section>
