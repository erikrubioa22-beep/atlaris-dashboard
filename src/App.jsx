...
const navGroups = [
  ...
  { label: "Administration", items: [{ id: "automation", label: "Automation", icon: "⌘" }, { id: "access", label: "Users & Access", icon: "♙" }, { id: "audit", label: "Audit Log", icon: "≋" }, { id: "settings", label: "Settings", icon: "⚙" }] },
];
